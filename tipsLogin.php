...
<html lang="en">
  <head>
    ...
    <title>Resume Tips-Resumizer</title>
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
              <h1 class="display-1"><a href="Homepage.php" class="text-light" style="text-decoration : none">
<h1 class="display-1">Resumizer</h1>
</a></h1>
              
              <nav class="nav nav-pills nav-justified">
                <a class="nav-link" href="Homepage.php"><font color="#F5FBFE">Home</font></a>
                <a class="nav-link" href="profile.php"><font color="#CBE7F9">My Profile</font></a>
                <!-- <a class="nav-link" href="#"><font color="#CBE7F9">Resume Tips</font></a> -->
                <a class="nav-link  " href="logout.php"><font color="#F5FBFE">Logout</font></a>
              </nav>
            </div>
          </div>
